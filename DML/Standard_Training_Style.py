...
parser.add_argument('--source_path',  default="/content/drive/My Drive/Divide and Conquer the Embedding Space for Metric Learning/metric-learning-divide-and-conquer/data/img.zip (Unzipped Files)",         type=str, help='Path to training data.')
...
for epoch in range(opt.n_epochs):
    ...
    #save model weight
    torch.save(model.state_dict(), 'weigth_gpu.pth')
    print('\n-----\n')

model = model.to('cpu')
torch.save(model.state_dict(), 'weigth_cpu.pth')
